module.exports = {
  ...
  BEEP: Buffer.from([0x1b, 0x42]), // Sounds built-in buzzer (if equipped)
  ...
  // Paper
  PAPER_FULL_CUT: Buffer.from([0x1b, 0x69]), // Full cut paper
  PAPER_PART_CUT: Buffer.from([0x1b, 0x69]), // Partial cut paper
  ...
  BARCODE_CODE128: Buffer.from([0x1d, 0x6b, 0x49]), // Barcode type CODE128
